...
const ProfileForm = ({initialData, onSuccess}) => {
    ...
    return (
        <form onSubmit={handleSubmit} className='card p-5 sm:p-6 mb-6'>
            ...
            {error && (
                <div className='bg-rose-50 border border-rose-200 text-rose-700 text-sm rounded-xl flex items-start gap-3 p-4 mb-4'>
            ...
            {message && (
                <div className='bg-emerald-50 border border-emerald-200 text-emerald-700 text-sm rounded-xl flex items-start gap-3 p-4 mb-4'>
            ...
            <div className='space-y-5'>
                ...
                <div>
                    ...
                    <textarea disabled={initialData.isDeleted} name='bio' defaultValue={initialData?.bio || ""} rows={3} className={`resize-none ${initialData.isDeleted ? "bg-slate-50 text-slate-400 cursor-not-allowed" : ""}`} placeholder='Write a brief bio...' />
